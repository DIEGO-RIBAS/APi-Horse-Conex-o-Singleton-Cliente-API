  ...
  type
    TControllerTarefa = class
      ...
      public
        ...
        function GetTotalTarefaConcluidas7Dias : Integer;
...
function TControllerTarefa.GetTotalTarefaConcluidas7Dias: Integer;
var
  ModelTarefa : TModelTarefa;
  jObject     : TJSONObject;
begin
  ...
  try
    ...
    jObject := ModelTarefa.GetTotaltarConcluida7Dias;
  finally
    FreeAndNil(ModelTarefa);
  end;
